...
##############################################################################
# Slackware ARM gcc-10.2.0 aarch64 cross-compiler for Raspberry Pi
#
...
echo " ## SARPi64 Project [sarpi64.fatdog.eu] "
echo " ############################################"
echo 
}
...
# create gcc-10.2.0 libsanitizer asan_linux-cpp.patch file
cd "$CWD"
touch asan_linux-cpp.patch
cat << EOF > asan_linux-cpp.patch
--- gcc-10.2.0/libsanitizer/asan/asan_linux.cpp	2020-12-29 22:57:16.000000000 +0000
+++ asan_linux.cpp	2020-12-29 23:20:04.000000000 +0000
@@ -76,6 +76,10 @@
...
# Patch gcc-10.2.x/libsanitizerasan/asan_linux.cpp [or the build will fail]
